...
export async function getMyServicesDB (userId){
    ...
    const query = `
        SELECT users.name AS name, services.status AS status, services.photo AS photo, services.name AS service, services.price AS price, services.id AS id FROM services
